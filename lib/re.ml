...
let rec simplify_re = function
    ...
    | Union (r1, Union (Literal r2, r3)) when not (is_literal r1) -> simplify_re (Union (Literal r2, Union (r1, r3)))
    | Union (r1, Literal r2) when not (is_literal r1) -> simplify_re (Union (Literal r2, r1))

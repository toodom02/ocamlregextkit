...
let is_subset_of r1 r2 =
    let n1 = NfaArray.re_to_nfa r1 and
        n2 = NfaArray.re_to_nfa r2 in
    let (n1', n2') = NfaArray.merge_alphabets n1 n2 in
    let d1 = DfaArray.nfa_to_dfa n1' and
        d2 = DfaArray.nfa_to_dfa n2' in
    let notd2 = DfaArray.complement d2 in
    DfaArray.is_empty (DfaArray.product_intersection d1 notd2)
